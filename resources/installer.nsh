!macro customCheckAppRunning
  ...
  nsExec::Exec 'taskkill /T /F /IM "Lygodactylus.exe"'
  Pop $R0
  ...
  nsExec::Exec 'powershell.exe -NoProfile -Command "Get-CimInstance Win32_Process | Where-Object { $$_.Name -eq ''node.exe'' -and ($$_.ExecutablePath -like ''*Lygodactylus*'' -or $$_.ExecutablePath -like ''*Open Cowork*'') } | ForEach-Object { Stop-Process -Id $$_.ProcessId -Force -ErrorAction SilentlyContinue }"'
  Pop $R0
...
!macro customUnInstallCheck
  ${if} $R0 != 0
    Push $R0
    Call LygodactylusShowLegacyUninstallHelp
  ${endif}
!macroend
