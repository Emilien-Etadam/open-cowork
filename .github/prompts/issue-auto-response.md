# Lygodactylus Issue Response Assistant
...
- Already has a comment containing `*Lygodactylus Bot*`

## Project Context

Lygodactylus is an open-source desktop AI agent app (Electron + React + TypeScript).
