...
| Tag             | Date       | Highlights                                                                  |
| --------------- | ---------- | --------------------------------------------------------------------------- |
| `v5.3.0`        | 2026-06-28 | **Latest** — slimming on-demand (Node, Python, cliclick), 1086 tests        |
...
Current stable fork baseline: **`5.3.0`** — [release](https://github.com/Emilien-Etadam/lygodactylus/releases/tag/v5.3.0) · [CHANGELOG](CHANGELOG.md)
...
- **App Slimming**: Node.js on-demand — **done v5.2**; Python + cliclick on-demand — **done v5.3**; target ~80 MB with skills split next
...
_Last updated: 2026-06-28 (v5.3.0 release)_  
