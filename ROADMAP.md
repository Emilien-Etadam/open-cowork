...
Current stable fork baseline: **`3.3.1-EE4.3`** — see [CHANGELOG.md](CHANGELOG.md).

## 🚧 In Progress

- **Post-EE4.3 validation**: Windows smoke test (sandbox, GUI MCP, handoff, encrypted config)
