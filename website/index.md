...
head:
  - - link
    - rel: canonical
      href: https://opencoworkai.github.io/lygodactylus/
  - - link
    - rel: alternate
      hreflang: en
      href: https://opencoworkai.github.io/lygodactylus/
  - - link
    - rel: alternate
      hreflang: zh-CN
      href: https://opencoworkai.github.io/lygodactylus/zh/
  - - link
    - rel: alternate
      hreflang: x-default
      href: https://opencoworkai.github.io/lygodactylus/
...
features:
  ...
  - icon: 🛡️
    ...
    details: MIT licensed. Fully transparent codebase. Your data stays local — no telemetry, no data sent to Lygodactylus servers.
---
...
brew install --cask --no-quarantine lygodactylus
```
...
### What is Lygodactylus?

Lygodactylus is a free, open-source AI agent desktop application for Windows and macOS. It wraps AI models (Claude, GPT, Gemini, DeepSeek, etc.) into a user-friendly GUI with one-click installation — no terminal or coding knowledge required.
...
Yes. Lygodactylus is completely free and open-source under the MIT license. You only pay for AI model API usage from your chosen provider.
...
Lygodactylus uses WSL2 (Windows) or Lima (macOS) to run all AI-executed commands inside an isolated Linux VM. Even if the AI makes a mistake, your host system files remain protected.
...
Lygodactylus runs entirely on your local machine. The only external communication is with the AI model API you configure. No data is sent to Lygodactylus servers.
